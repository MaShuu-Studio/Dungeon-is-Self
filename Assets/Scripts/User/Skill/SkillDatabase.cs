...
namespace Data
{
    public class SkillDatabase : MonoBehaviour
    {
        ...
        private void InitializeCharacterSkill()
        {
            ...
            #region Knight Skill
            charSkillDB.Add(new CharacterSkill(10100, 0, "베기", true, turn: 0, damage: 7, 
                description: "적을 칼로 벤다."));

            charSkillDB.Add(new CharacterSkill(10101, 1, "찌르기", true, turn: 0, damage: 9,
                description: "적을 칼로 강하게 찌른다."));

            charSkillDB.Add(new CharacterSkill(10102, 1, "도발", true, turn: 0, damage: 0,
            ...
            charSkillDB.Add(new CharacterSkill(10103, 2, "작살베기", true, turn: 0, damage: 18
                , description: "작살로 적을 베어 큰 피해를 입힌다."));

            charSkillDB.Add(new CharacterSkill(10104, 2, "방패찍기", true, turn: 0, damage: 13,
            ...
            charSkillDB.Add(new CharacterSkill(10105, 2, "강철방패", false, turn: 1, damage: 0,
            ...
            charSkillDB.Add(new CharacterSkill(10106, 2, "야성의외침", false, turn: 0, damage: 0,
            ...
            charSkillDB.Add(new CharacterSkill(10107, 3, "반격", true, turn: 1, damage: 20,
            ...
            charSkillDB.Add(new CharacterSkill(10108, 3, "용기", false, turn: 1, damage: 0,
            ...
            charSkillDB.Add(new CharacterSkill(10109, 4, "가시방패", true, turn: 2, damage: 30,
            ...
            charSkillDB.Add(new CharacterSkill(10110, 4, "데드락", true, turn: 1, damage: 30,
            ...
            charSkillDB.Add(new CharacterSkill(10111, 4, "포효", false, turn: 2, damage: 10,
            ...
            charSkillDB.Add(new CharacterSkill(10200, 0, "화살쏘기", false, turn: 0, damage: 9
                , description: "화살을 발사한다."));
            charSkillDB.Add(new CharacterSkill(10201, 1, "더블샷", false, turn: 0, damage: 11
                , description: "화살을 동시에 두 발을 발사한다."));
            charSkillDB.Add(new CharacterSkill(10202, 1, "그물화살", false, turn: 0, damage: 8,
                description: "그물로 몸을 옭아매는 화살을 쏜다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30602), 1),
                }));
            charSkillDB.Add(new CharacterSkill(10203, 2, "트리플샷", false, turn: 0, damage: 20
                , description: "화살을 동시에 세 발을 발사한다."));
            charSkillDB.Add(new CharacterSkill(10204, 2, "톱날화살", false, turn: 0, damage: 16,
                description: "톱날같은 화살을 발사해 적에게 출혈을 입힌다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30801), 3),
                }));
            charSkillDB.Add(new CharacterSkill(10205, 2, "파워샷", false, turn: 1, damage: 32,
                description: "기를 모아 강력한 화살을 발사한다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30701), 1),
                }));
            charSkillDB.Add(new CharacterSkill(10206, 2, "화살촉 강화", false, turn: 0, damage: 0,
                description: "화살촉에 강력한 힘을 담는다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30901), 0),
                }));
            charSkillDB.Add(new CharacterSkill(10207, 3, "화살비", false, turn: 1, damage: 60,
                description: "화살을 하늘에 쏘아 강력한 화살비를 적에게 내린다.",
                new List<int> { 10203 }));
            charSkillDB.Add(new CharacterSkill(10208, 3, "독화살", false, turn: 0, damage: 24,
            ...
            charSkillDB.Add(new CharacterSkill(10209, 3, "저격", false, turn: 1, damage: 60,
            ...
            charSkillDB.Add(new CharacterSkill(10210, 3, "매 소환", false, turn: 0, damage: 0,
            ...
            charSkillDB.Add(new CharacterSkill(10211, 4, "헤드샷", false, turn: 2, damage: 150,
            ...
            #region Mage Skill
            charSkillDB.Add(new CharacterSkill(10300, 0, "기본공격", true, turn: 0, damage: 5
                , description: "지팡이를 휘둘러 상대를 공격한다."));
            charSkillDB.Add(new CharacterSkill(10301, 1, "라이트닝",false, turn: 0, damage: 13
                , description: "전격을 생성하여 적에게 내리친다."));
            charSkillDB.Add(new CharacterSkill(10302, 1, "고드름", false, turn: 0, damage: 13
                , description: "고드름을 생성하여 발사한다."));
            charSkillDB.Add(new CharacterSkill(10303, 1, "파이어볼", false, turn: 0, damage: 13
                , description: "화염구를 생성하여 발사한다."));
            charSkillDB.Add(new CharacterSkill(10304, 2, "번개구름", false, turn: 0, damage: 20,
                description: "번개구름을 소환하여 적에게 내리친다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30602), 1),
                }));
            charSkillDB.Add(new CharacterSkill(10305, 2, "빙결감옥", false, turn: 1, damage: 35,
                description: "얼음으로 된 감옥으로 상대를 가두어 얼린다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30701), 1),
                }));
            charSkillDB.Add(new CharacterSkill(10306, 2, "블레이즈", false, turn: 1, damage: 48,
                description: "강력한 화염을 일으켜 상대를 불태운다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30803), 4),
                }));
            charSkillDB.Add(new CharacterSkill(10307, 3, "전격폭발", false, turn: 0, damage: 30,
            ...
            charSkillDB.Add(new CharacterSkill(10308, 3, "블리자드", false, turn: 1, damage: 50,
            ...
            charSkillDB.Add(new CharacterSkill(10309, 3, "파이어월", false, turn: 2, damage: 105,
            ...
            charSkillDB.Add(new CharacterSkill(10310, 4, "뇌룡", false, turn: 2, damage: 180,
            ...
            charSkillDB.Add(new CharacterSkill(10311, 4, "빙하기", false, turn: 2, damage: 180,
            ...
            charSkillDB.Add(new CharacterSkill(10312, 4, "메테오", false, turn: 2, damage: 180,
        ...
        private void InitializeMonsterSkill()
        {
            ...
            #region 스네이크
            monSkillDB.Add(new MonsterSkill(203111, "물기", true, 0, cost: 2,
                description: "상대를 물어 마비독을 주입한다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30602), 2),
                }));
            monSkillDB.Add(new MonsterSkill(203112, "탈피", false, 0, cost: 1,
                description: "탈피하여 안 좋은 효과들을 해제한다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30401), 0),
                }));
            monSkillDB.Add(new MonsterSkill(203113, "뱀의 눈", false, 0, cost: 1,
                description: "뱀 눈으로 상대를 위협해 사기를 떨어뜨린다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30902), 0),
                }));
            monSkillDB.Add(new MonsterSkill(203121, "꼬리속박", true, 0, cost: 5,
                description: "꼬리로 상대 1명을 행동 불능으로 만든다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30701), 0),
                }));            
            monSkillDB.Add(new MonsterSkill(203122, "또아리말기", false, 0, cost: 3,
                description: "몸을 말아 상대 공격을 방어한다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30202), 0),
                }));
            monSkillDB.Add(new MonsterSkill(203123, "흡혈", true, 0, cost: 2,
                description: "상대 체액을 빨아 체력을 흡수한다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(31101), 25),
                }));            
            monSkillDB.Add(new MonsterSkill(203131, "독안개", false, 0, cost: 6,
                description: "마비독 안개를 생성하여 모든 적을 마비시킨다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30603), 2),
                }));
            monSkillDB.Add(new MonsterSkill(203132, "선악과", true, 0, cost: 7,
            ...
            #region 구미호
            monSkillDB.Add(new MonsterSkill(204111, "회피", false, 0, cost: 2,
                description: "빠르게 움직여 상대의 특수효과를 피한다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30202), 0),
                }));
            monSkillDB.Add(new MonsterSkill(204112, "정기 흡수", false, 0, cost: 1,
                description: "상대의 정기를 흡수하여 이로운 효과를 제거한다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(31401), 0),
                }));
            monSkillDB.Add(new MonsterSkill(204113, "여우불", false, 0, cost: 0,
                description: "여우불을 소환하여 상대에게 더 큰 효과를 준다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(31001), 0),
                }));
            monSkillDB.Add(new MonsterSkill(204114, "매혹적인 눈빛", false, 0, cost: 1,
                description: "매혹적인 눈빛으로 상대의 공격 의지를 감소시킨다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30902), 0),
                }));
            monSkillDB.Add(new MonsterSkill(204121, "털갈이", false, 0, cost: 2,
                description: "오염된 털을 제거한다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(30401), 0),
                }));
            monSkillDB.Add(new MonsterSkill(204131, "유혹", false, 0, cost: 5,
                description: "상대를 유혹하여 혼란에 빠뜨린다.",
                new List<System.Tuple<CrowdControl, int>>()
                {
                    new System.Tuple<CrowdControl, int>(GetCrowdControl(31301), 0),
                }));
            monSkillDB.Add(new MonsterSkill(204132, "여우구슬", false, 0, cost: 5,
            ...
            monSkillDB.Add(new MonsterSkill(204133, "정신조종", false, 0, cost: 5,
            ...
            #region Attack
            monSkillDB.Add(new MonsterSkill(200211, "전체공격", true, 10, cost: 0,
                description: "모든 적을 공격한다."));
            monSkillDB.Add(new MonsterSkill(200311, "단일공격", true, 4, cost: 0,
                description: "하나의 적을 공격한다."));
            monSkillDB.Add(new MonsterSkill(200411, "스턴공격", true, 5, cost: 0,
        ...
        public bool IsMovementSkill(int id)
        {
            string str = id.ToString();
            Skill skill = null;
            if (str[0] == '1')
                skill = charSkillDB.Find(item => item.id == id);
            else 
                skill = monSkillDB.Find(item => item.id == id);

            if (skill != null) return skill.move;
            else return false;
        }

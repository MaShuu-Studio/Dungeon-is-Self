...
public class S_BroadcastEnterGame : IPacket
{
    ...
    public void Read(ArraySegment<byte> segment)
    {
		...
		count += sizeof(int);
		this.xPos = BitConverter.ToSingle(segment.Array, segment.Offset + count);
		count += sizeof(float);
		this.yPos = BitConverter.ToSingle(segment.Array, segment.Offset + count);
		count += sizeof(float);
		this.zPos = BitConverter.ToSingle(segment.Array, segment.Offset + count);
		count += sizeof(float);
    }
    ...
    { 
		...
		Array.Copy(BitConverter.GetBytes(this.xPos), 0, segment.Array, segment.Offset + count, sizeof(float));
		count += sizeof(float);
		
		Array.Copy(BitConverter.GetBytes(this.yPos), 0, segment.Array, segment.Offset + count, sizeof(float));
		count += sizeof(float);
		
		Array.Copy(BitConverter.GetBytes(this.zPos), 0, segment.Array, segment.Offset + count, sizeof(float));
		count += sizeof(float);
